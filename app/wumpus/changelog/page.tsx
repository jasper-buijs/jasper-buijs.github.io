...
import { ChangeIconGrid, ChangeIconGridElement } from "@/app/components/wumpus/changelog/ChangeIcon";
import CodeBlock from "@/app/components/wumpus/changelog/CodeBlock";

const WumpusChangelogPage = () => {
  return (
    <>
      ...
      <div className="bg-[#D6D6D6] dark:bg-[#1E1E1E] text-[#1E1E1E] dark:text-inherit py-1 px-4 pt-2 mx-12 my-4 grid">
        ...
        <a href="https://github.com/jasper-buijs/discord-bot-js/releases" target="_blank" className="rounded-md p-2 bg-[#cfb53b] text-[#ffffff] w-max h-min row-start-1 row-span-1 col-start-2 col-span-1 mx-4 align-middle mb-1 justify-self-end">GitHub ↗︎</a>
      </div>

      <Paragraph title="Release 3.4.3">
        <ChangeIconGrid>
          <ChangeIconGridElement type="fixed">
            Fixed a bug that would cause the bot status to not be updated when playing music.
          </ChangeIconGridElement>
          <ChangeIconGridElement type="added">
            Added more custom statuses.
          </ChangeIconGridElement>
        </ChangeIconGrid>
      </Paragraph>
      ...
      <Paragraph title="Release 3.4.2">
        <ChangeIconGrid>
          <ChangeIconGridElement type="fixed">
            Fixed a bug that would cause the custom status message to clear after playing music.
          </ChangeIconGridElement>
        </ChangeIconGrid>
      </Paragraph>
      ...
      <Paragraph title="Release 3.4.1">
        <ChangeIconGrid>
          <ChangeIconGridElement type="added">
            Added custom status messages, randomly selected each day from a pool.
          </ChangeIconGridElement>
        </ChangeIconGrid>
      </Paragraph>
      ...
      <Paragraph title="Release 3.4.0">
        <ChangeIconGrid>
          <ChangeIconGridElement type="added">
            Added a voice channel named "the abyss of awkwardness", joining it will auto-create a new temporary voice channel.
          </ChangeIconGridElement>
      ...
      <Paragraph title="Release 3.3.1">
        <ChangeIconGrid>
          <ChangeIconGridElement type="added">
            Added the showing of the green rally color for everyone who responded to the Rallly. These green roles will stay until the start of the Rallly data.
          </ChangeIconGridElement>
          <ChangeIconGridElement type="fixed">
            When the Rallly roles are updated. It will now update once 30 seconds after (re-)starting the bot, and then every day at 10 minutes past midnight.
          </ChangeIconGridElement>
      ...
      <Paragraph title="Release 3.3.0">
        <ChangeIconGrid>
          <ChangeIconGridElement type="added">
            Added support for Rallly data in the form of custom colored roles. These roles reflect availability on the current day and update twice a day (once at 3:00 AM and once a minute after the time at which the bot was started).
          </ChangeIconGridElement>
          <ChangeIconGridElement type="fixed" command="/play">
...
export default WumpusChangelogPage;