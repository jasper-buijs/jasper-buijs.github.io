...
const StreamPlayer = () => {
  ...
  return (
    <>
      <div className={"block py-6 pl-2 pr-20 overflow-hidden"}>
        <div className={"h-full w-full"}>
          ...
          <div className={"mt-2 h-full"}>
            <div className={"grid grid-cols-[repeat(auto-fit,_minmax(32px,_1fr))] gap-2 h-[80%] content-start"}>
            ...
            <div className={"h-[20%] content-end pt-4"}>
              <button
              ...
              <input
                ...
                className={"inline-block h-8 bg-gray-500 w-[calc(100%-40px)] align-middle max-w-[50%]"}
              />
            </div>
          </div>
        </div>
