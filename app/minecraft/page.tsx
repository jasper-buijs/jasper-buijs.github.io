  ...
  return (
    <>
      ...
      <Paragraph emoji="ℹ️" title="General Info">
        Our server is back! New start, new world, same concept. We play in hard-difficulty survival, with PvP enabled but (usually) not the essence of the server. Everyone is free to join on <b>minecraft.heiligemaagden.com</b>. The server is vanilla-ish - though we run some mods to optimise game handling barely anything in-game gets changed. We also use four datapacks to alter the game behavior slightly:
        <ol>
