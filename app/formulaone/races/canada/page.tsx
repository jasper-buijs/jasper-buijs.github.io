    ...
    <>
      ...
      <div className="h-[28vw] mx-12 bg-gradient-to-r from-[#EA2C36] to-[#010101]">
        <div className="h-full w-full relative">
          <img className="absolute w-full h-auto top-1/2 translate-y-[-50%]" src="/formulaone/banners-dated/canada-header-dated.webp" alt={""} />
        </div>
      </div>
        ...
        <div className="h-full w-full m-auto overflow-x-auto whitespace-nowrap">
          <div className={"h-max w-max m-auto"}>
            ...
            <a href="/formulaone/races/canada/race-result.webp" target="_blank">
              <img src="/formulaone/races/canada/race-result.webp" className="inline-block h-96 m-2" alt={"Race Results. Charles Leclerc won, Piastri came second and Sainz third."} />
            </a>*/}
          </div>
        </div>
      </Paragraph>
      <Paragraph title="Schedule">
        <table className="w-max m-auto table-auto">
          ...
          <tr>
            ...
            <td className="pr-2">
              {[new Date("June 7, 2024 13:30:00 UTC-04:00").toLocaleString(undefined, { weekday: "long", hour: "2-digit", minute: "2-digit" }), "-",
                new Date("June 7, 2024 14:30:00 UTC-04:00").toLocaleString(undefined, { hour: "2-digit", minute: "2-digit" })].join(" ")}
            </td>
          </tr>
          <tr>
            <td className="pr-2">{f1}Practice 2</td>
            <td className="pr-2">
              {[new Date("June 7, 2024 17:00:00 UTC-04:00").toLocaleString(undefined, { weekday: "long", hour: "2-digit", minute: "2-digit" }), "-",
                new Date("June 7, 2024 18:00:00 UTC-04:00").toLocaleString(undefined, { hour: "2-digit", minute: "2-digit" })].join(" ")}
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td className="pr-2">
              {[new Date("June 8, 2024 12:30:00 UTC-04:00").toLocaleString(undefined, { weekday: "long", hour: "2-digit", minute: "2-digit" }), "-",
                new Date("June 8, 2024 13:30:00 UTC-04:00").toLocaleString(undefined, { hour: "2-digit", minute: "2-digit" })].join(" ")}
            </td>
          </tr>
          <tr>
            <td className="pr-2">{f1}Qualifying</td>
            <td className="pr-2">
              {[new Date("June 8, 2024 16:00:00 UTC-04:00").toLocaleString(undefined, { weekday: "long", hour: "2-digit", minute: "2-digit" }), "-",
                new Date("June 8, 2024 17:00:00 UTC-04:00").toLocaleString(undefined, { hour: "2-digit", minute: "2-digit" })].join(" ")}
            </td>
          ...
          <tr>
            ...
            <td className="pr-2">
              {[new Date("May 26, 2024 14:00:00 UTC-04:00").toLocaleString(undefined, { weekday: "long", hour: "2-digit", minute: "2-digit" }), "-",
                new Date("May 26, 2024 16:00:00 UTC-04:00").toLocaleString(undefined, { hour: "2-digit", minute: "2-digit" })].join(" ")}
            </td>
