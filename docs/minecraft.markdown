...
3. We have one that makes nametags craftable.
4. Lastly, we have one that pauzes the game when no one is online, that way the total age of the server will beter represent overall playtime by our players.
<div class="gap"></div>
...
### World Map
This is a top-down view of the overworld. This map will be updated once every day around 7 am.
<iframe
