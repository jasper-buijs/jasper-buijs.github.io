    ...
    <>
      ...
      <div className="pl-2 pr-20 py-6">
        <Paragraph title="Release 4.0.0">
          <ChangeIconGrid>
            <ChangeIconGridElement type="updated" label="update">
              We&apos;ve rewritten the bot from scratch, meaning all previous functionality has been removed and will be re-added in coming updates.
            </ChangeIconGridElement>
            <ChangeIconGridElement type="updated" label="update">
              The bot has been rebranded to &quot;Magmuth&quot;, as the name &quot;Wumpus&quot; has been banned by Discord.
            </ChangeIconGridElement>
            <ChangeIconGridElement type="added" command="GIF Filter">
              Added a gif-filter. Sending messages containing gifs in non-spam channels is allowed in limited amounts. Sending more than three messages in half an hour will see these messages being removed. Sending more than five in an hour will warrant timeouts in Discord.
            </ChangeIconGridElement>
          </ChangeIconGrid>
        </Paragraph>
