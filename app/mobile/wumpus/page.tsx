...
const Home = () => {
  ...
  <div className="py-6 pl-2 pr-20">
    <div className="bg-[#D6D6D6] dark:bg-[#1E1E1E] text-[#1E1E1E] dark:text-inherit py-2 px-4 grid">
      <div className="row-start-1 row-span-1 col-start-1 col-span-1 align-middle my-auto">Now on v3.4.3!</div>
      <a href="/mobile/wumpus/changelog"
    ...
    <div className="border-l-4 border-blue-600 px-4 py-2 mt-6">
      ...
      We are still in the process of rewriting this bot. As of now, there&apos;s not much to see here. We have a
      (private)
      roadmap of what we wish to do, but we are not setting any deadlines. We&apos;ll update this page as we progress
      and
      add features, specifically the{" "}
    ...
    <div className="border-l-4 border-purple-600 px-4 py-2 mt-4">
      ...
      Please carefully read our licensing information below before using any code in this repository, as this project
      is not licensed and is provided without any permissions or grants of use.
    </div>
    ...
    <div>
      ...
      It&apos;s still early days in our rewrite of this bot. You&apos;ll find more information on our features here
      soon!
    </div>
    ...
    <div>
      ...
      can find more info about these and any other third-party software we use by using the links down below.
    </div>
