    ...
    <>
      ...
      <Paragraph title={"Quick Links"}>
        <div className={"grid grid-cols-3 w-full mb-4"}>
          ...
          <button onClick={() => {setMapsOverlayVisibility(true); setPlace("milan");}} className={"col-start-3 m-auto"}>
            <Image src={"/thiings/airbnb-2.png"} className={"h-60 w-96 px-[4.5rem]"} alt={"AirBnB Milano"} width={1024} height={1024} />
            <div className={"w-96 text-center font-semibold text-4xl -mt-4"}>AirBnB Milan</div>
            <div className={"w-96 text-center mt-1"}>Via Lanfranco della Pila 66, Milan, Italy</div>
          </button>
        </div>
      </Paragraph>
      <Paragraph title={"Documents"}>
        <div>
          ...
          <a href={"/italy-docs/vlucht-lang-heen.pdf"} target={"_blank"} className={"underline"}>Tickets vlucht BRU-FCO <ExternalLink size={20} className={"inline-block ml-1"} /></a><br />
          <a href={"/italy-docs/trein.pdf"} target={"_blank"} className={"underline"}>Tickets trein Rome-Milaan <ExternalLink size={20} className={"inline-block ml-1"} /></a><br />
