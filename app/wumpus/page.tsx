  ...
  return (
    <>
      ...
      <div className="bg-[#D6D6D6] dark:bg-[#1E1E1E] text-[#1E1E1E] dark:text-inherit py-1 px-4 pt-2 mx-12 my-4 grid">
        ...
        <a href="/wumpus/changelog" className="rounded-md p-2 bg-[#cfb53b] text-[#ffffff] w-max h-min row-start-1 row-span-1 col-start-2 col-span-1 mx-4 align-middle mb-1 justify-self-end">
          Change Log
        </a>
      </div>
      ...
      <div id="README" className="px-12">
        ...
        <div className="border-l-4 border-blue-600 px-4 py-2 mt-6">
          ...
          paragraph. Check back soon for more!
        </div>
