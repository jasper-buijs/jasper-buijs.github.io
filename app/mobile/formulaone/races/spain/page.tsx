...
const Page = () => {
  redirect("/formulaone/races/spain", true);
  ...
  return (<>
    ...
    <div className="py-6 pl-2 pr-20">
      <div className="h-[28vw] mb-4 bg-gradient-to-r from-[#E20612] to-[#FFD403]">
        ...
        <div className="h-full w-full m-auto overflow-x-auto whitespace-nowrap">
          <div className={"h-max w-max m-auto"}>
            <a href="/formulaone/races/spain/circuit.webp" target="_blank">
              <img src="/formulaone/races/spain/circuit.webp" className="inline-block h-48 m-2"
            ...
            <a href="/formulaone/races/spain/starting-grid.webp" target="_blank">
              <img src="/formulaone/races/spain/starting-grid.webp" className="inline-block h-48 m-2"
            ...
            <a href="/formulaone/races/spain/race-result.webp" target="_blank">
              <img src="/formulaone/races/spain/race-result.webp" className="inline-block h-48 m-2"
      ...
      <Paragraph title="Formula 2">
        <div className="h-max w-full m-auto">
          <a href="/formulaone/races/bahrain/f2-sprint.webp" target="_blank">
            <img src="/formulaone/races/spain/f2-sprint.webp" className="block w-full my-2" alt={"Formula 2 Sprint results."} />
          </a>
          <a href="/formulaone/races/spain/f2-feature.webp" target="_blank">
            <img src="/formulaone/races/spain/f2-feature.webp" className="block w-full my-2" alt={"Formula 2 Feature results."} />
          </a>
        </div>
      </Paragraph>
      <Paragraph title="Formula 3">
        <div className="h-max w-full m-auto">
          <a href="/formulaone/races/spain/f3-sprint.webp" target="_blank">
            <img src="/formulaone/races/spain/f3-sprint.webp" className="block w-full my-2" alt={"Formula 3 Sprint results."} />
          </a>
          <a href="/formulaone/races/spain/f3-feature.webp" target="_blank">
            <img src="/formulaone/races/spain/f3-feature.webp" className="block w-full my-2" alt={"Formula 3 Feature results."} />
          </a>
        </div>
      </Paragraph>
      <Paragraph title="F1 Academy">
        <div className="h-max w-full m-auto">
          <a href="/formulaone/races/spain/f1a-race1.webp" target="_blank">
            <img src="/formulaone/races/spain/f1a-race1.webp" className="block w-full my-2" alt={"F1 Academy Race 1 results."} />
          </a>
          <a href="/formulaone/races/spain/f1a-race2.webp" target="_blank">
            <img src="/formulaone/races/spain/f1a-race2.webp" className="block w-full my-2" alt={"F1 Academy Race 2 results."} />
          </a>
        </div>
      </Paragraph>
    </div>
