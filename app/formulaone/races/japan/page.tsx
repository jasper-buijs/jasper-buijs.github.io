    ...
    <>
      ...
      <div className="h-[28vw] mx-12 bg-gradient-to-r from-[#BD022F] to-[#FF5782]">
        <div className="h-full w-full relative">
          <img className="absolute w-full h-auto top-1/2 translate-y-[-50%]" src="/formulaone/banners-dated/japan-header-dated.png" />
        </div>
      </div>
        ...
        <table className="w-max m-auto table-auto">
          <tbody>
            ...
            <tr>
              ...
              <td className="pr-2">{[new Date("April 5, 2024 11:30:00 GMT+09:00").toLocaleString(undefined, { weekday: "long", hour: "2-digit", minute: "2-digit" }), "-", new Date("April 5, 2024 12:30:00 GMT+09:00").toLocaleString(undefined, { hour: "2-digit", minute: "2-digit" })].join(" ")}</td>
            </tr>
            <tr>
              <td className="pr-2">{f1}Practice 2</td>
              <td className="pr-2">{[new Date("April 5, 2024 15:00:00 GMT+09:00").toLocaleString(undefined, { weekday: "long", hour: "2-digit", minute: "2-digit" }), "-", new Date("April 5, 2024 16:00:00 GMT+09:00").toLocaleString(undefined, { hour: "2-digit", minute: "2-digit" })].join(" ")}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="pr-2">{[new Date("April 6, 2024 11:30:00 GMT+09:00").toLocaleString(undefined, { weekday: "long", hour: "2-digit", minute: "2-digit" }), "-", new Date("April 6, 2024 12:30:00 GMT+09:00").toLocaleString(undefined, { hour: "2-digit", minute: "2-digit" })].join(" ")}</td>
            </tr>
            <tr>
              <td className="pr-2">{f1}Qualifying</td>
              <td className="pr-2">{[new Date("April 6, 2024 15:00:00 GMT+09:00").toLocaleString(undefined, { weekday: "long", hour: "2-digit", minute: "2-digit" }), "-", new Date("April 6, 2024 16:00:00 GMT+09:00").toLocaleString(undefined, { hour: "2-digit", minute: "2-digit" })].join(" ")}</td>
            ...
            <tr>
              ...
              <td className="pr-2">{[new Date("April 7, 2024 14:00:00 GMT+09:00").toLocaleString(undefined, { weekday: "long", hour: "2-digit", minute: "2-digit" }), "-", new Date("April 7, 2024 16:00:00 GMT+09:00").toLocaleString(undefined, { hour: "2-digit", minute: "2-digit" })].join(" ")}</td>
